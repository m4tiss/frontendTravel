...
import italySlider from '../images/sliderImages/spainSlider.jpg';
...
const ImageSlider = () => {
  ...
  return (
    <div class="hidden lg:flex my-2 items-center justify-center h-[500px] w-full">
        <div class="flex flex-col items-start justify-end px-20 py-10 bg-cover h-[500px] rounded-md md:w-[1000px] xl:w-[1400px] " style={{backgroundImage: `url(${italySlider})`}}>  
